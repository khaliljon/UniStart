...
namespace UniStart.Migrations
{
    ...
    [Migration("20251106204120_AddTestsModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniStart.Models.Test", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UniStart.Models.TestAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UniStart.Models.TestQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UniStart.Models.UserTestAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UniStart.Models.UserTestAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UniStart.Models.Tag", b =>
                {
                    b.HasOne("UniStart.Models.Test", null)
                        .WithMany("Tags")
            ...
            modelBuilder.Entity("UniStart.Models.TestAnswer", b =>
                {
                    b.HasOne("UniStart.Models.TestQuestion", "Question")
                        .WithMany("Answers")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UniStart.Models.TestQuestion", b =>
                {
                    b.HasOne("UniStart.Models.Test", "Test")
                        .WithMany("Questions")
                        .HasForeignKey("TestId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("UniStart.Models.UserTestAnswer", b =>
                {
                    b.HasOne("UniStart.Models.UserTestAttempt", "Attempt")
                    ...
                    b.HasOne("UniStart.Models.TestAnswer", "SelectedAnswer")
                        .WithMany()
