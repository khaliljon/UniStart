...
import aiService, { RecommendedQuiz } from '../../services/aiService';
import { useNavigate } from 'react-router-dom';

const AIRecommendedQuizzes = () => {
  ...
  const loadRecommendations = async () => {
    try {
      const data = await aiService.getRecommendedQuizzes(3);
      ...
      <Card className="bg-gradient-to-br from-blue-500 to-indigo-600 text-white">
        <div className="mb-4">
          ...
          <p className="text-sm opacity-90">
            Квизы, которые помогут закрепить ваши знания
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-4 text-xs text-white/90">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span>{rec.estimatedDuration} мин</span>
                </div>
              </div>
            </div>
          ))}
...
export default AIRecommendedQuizzes;
